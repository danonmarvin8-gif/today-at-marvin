/**
 * AppleIcon — inline SVG du logo Apple
 * Source du path : Simple Icons (simpleicons.org), viewBox 0 0 24 24
 * Toutes les coordonnées sont dans le viewBox → aucun clip, compatible
 * Windows, Android, Linux. fill="currentColor" → hérite la couleur du parent.
 */
export function AppleIcon({ className = 'apple-icon' }: { className?: string }) {
  return (
    <svg
      className={className}
      aria-hidden="true"
